...
namespace PsyDiagnostics.Models
{
    ...
    public enum CrimeType
    {
        ...
        [Description("Умышленное причинение тяжкого вреда здоровью")]
        ТяжкийВредЗдоровью,

        [Description("Умышленное причинение средней тяжести вреда здоровью")]
        СреднийВредЗдоровью,

        [Description("Легкий вред здоровью")]
        ЛегкийВредЗдоровью,

        [Description("Побои")]
        Побои,

        [Description("Угроза убийством")]
        УгрозаУбийством,

        [Description("Изнасилование")]
        Изнасилование,

        [Description("Насильственные действия сексуального характера")]
        НасильственныеДействияСексуальногоХарактера,
        ...
        [Description("Присвоение или растрата")]
        ПрисвоениеИлиРастрата,
        ...
        [Description("Хулиганство")]
        Хулиганство,

        [Description("Незаконное хранение наркотиков")]
        ХранениеНаркотиков,

        [Description("Сбыт наркотиков")]
        СбытНаркотиков,

        [Description("Нарушение ПДД")]
        НарушениеПДД,

        [Description("Управление ТС в состоянии опьянения")]
        ВождениеВСостоянииОпьянения,

        [Description("Применение насилия к представителю власти")]
        НасилиеКПредставителюВласти,

        [Description("Подделка документов")]
        ПодделкаДокументов
    }
